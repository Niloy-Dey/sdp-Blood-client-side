...
const Login = () => {
    ...
    return (
        <div className='bg-red-100 m-40 card mx-auto w-96 shadow-lg p-5  flex justify-center items-center'>
        ...
        >
            ...
            <div className=" mx-auto">
                ...
                <br />
                <button type="submit"  onClick={() => signInWithEmailAndPassword(email, password)} className="w-full bg-red-300 rounded-lg p-3 my-3"><strong>LOGIN</strong></button>
                <br />
                <button onClick={() => signInWithGoogle()} className="btn  bg-red-400 w-full  py-3 fw-bold">Continue With Google</button>
            </div>
        </form >
           </div>
    );
